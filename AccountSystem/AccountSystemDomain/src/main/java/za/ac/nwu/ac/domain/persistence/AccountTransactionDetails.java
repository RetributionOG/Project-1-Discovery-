...
@Entity
@Table(name = "DEMO_ACCOUNT_TX_DETAILS", schema = "DEMO_SCHEMA")
public class AccountTransactionDetails implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "ACCOUNT_SEQ", sequenceName = "HR.DEMO_ACCOUNT_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ACCOUNT_SEQ")
    @Column(name = "DEMO_ACCOUNT_TX_DETAILS_ID")
