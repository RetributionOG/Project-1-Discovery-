...
public class AccountType implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "DEMO_ACCOUNT_TYPE_SEQ", sequenceName = "HR.DEMO_ACCOUNT_TYPE_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DEMO_ACCOUNT_TYPE_SEQ")
