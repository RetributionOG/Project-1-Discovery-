...
public class AccountTypeController
{
    ...
    @GetMapping("/all")
    @ApiOperation(value = "Get all the configured data types", notes = "Returns a list of account types" )
    @ApiResponses(value = {
    ...
    @PostMapping("")
    @ApiOperation(value = "Creates a AccountType", notes = "Creates a new AccountType in the DB")
    @ApiResponses(value = {
    ...
    @GetMapping("{mnemonic}")
    @ApiOperation(value = "Fetches the specified AccountType.", notes = "Fetches the AccoutType corresponding to the given mnemonic")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "AccountType returned", response = GeneralResponse.class),
            @ApiResponse(code = 400, message = "Bad Request", response = GeneralResponse.class),
            @ApiResponse(code = 404, message = "Not Found", response = GeneralResponse.class),
            @ApiResponse(code = 500, message = "Internal Server Error", response = GeneralResponse.class)})
    public ResponseEntity<GeneralResponse<AccountTypeDto>> getAccountType(
        ...
        AccountTypeDto accountType = fetchAccountTypeFlow.getAccountTypeDtoByMnemonic(mnemonic);
        GeneralResponse<AccountTypeDto> response = new GeneralResponse<>(true, accountType);
        return new ResponseEntity(response, HttpStatus.OK);
    }

    @DeleteMapping("{mnemonic}")
    @ApiOperation(value = "Deletes the specified AccountType.", notes = "Deletes the AccoutType corresponding to the given mnemonic")
    @ApiResponses(value = {
