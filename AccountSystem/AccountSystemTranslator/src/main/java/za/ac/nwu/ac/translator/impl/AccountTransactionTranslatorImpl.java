...
public class AccountTransactionTranslatorImpl implements AccountTransactionTranslator {
    ...
    {
        try{
            AccountTransaction accountTransaction = accountTransactionRepository.save(accountTransactionDto.getTransactionType());
    ...
    public AccountTransactionDto getAccountTransactionDtoByMemberId(Long memberId) {
        try{
            return accountTransactionRepository.getAccountTransactionDtoByMember(memberId);
        }
        catch (Exception e){
            throw new RuntimeException("Unable to read from the DB", e);
        }
